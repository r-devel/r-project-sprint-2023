...
We are currently soliciting ideas and proposals for R Project Sprint 2023 projects.

Projects should be related to code or documentation maintained by the R Core Team.
Priority will be given to projects that have the support of R Core either directly (an R Core member has authored a proposal or commented in favour) or indirectly (the project follows established pathways of contributing to R bugs or translations).
...
An **idea** may be 
  ...
  - A small task that could be
      ...
      - picked up by a sprint participant if they have spare time 
      alongside a larger project.

Suggest an **idea** by opening a thread in the [ideas](https://github.com/r-devel/r-project-sprint-2023/discussions/categories/ideas) 
category of Discussions in the [r-project-sprint-2023](https://github.com/r-devel/r-project-sprint-2023) GitHub repository. 

## Proposals

Project **proposals** must be created by a [sprint participant](/participants), 
potentially in collaboration with external contributors.

A project **proposal** should outline a specific package of work where good progress 
...
Note this assumes you accepted your invitation to the R-devel GitHub organization 
- please contact [r-project-sprint-2023\@gaggle.email](mailto:r-project-sprint-2023@gaggle.email) if you have any issues.
