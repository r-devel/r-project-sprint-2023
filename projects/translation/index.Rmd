...
In addition, the process of contributing messages has changed. The new [Weblate server](https://translate.rx.studio/projects/r-project/) provides a user-friendly interface for contributing translations, making it easier for R users to contribute. However there is a need to document the process of contribution and provide guidelines for contributors, to ensure quality and consistency.
...
As time allow, translators can work towards further targets as appropriate, contributing translations, reviewing each other's translators and making sure the strings pass Weblate's checks (e.g. no trailing white space).
