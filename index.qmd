...
::: flex-container
[![](media/eth_logo.png){fig-alt="ETH Studio logo" fig-align="left" width="252"}](https://math.ethz.ch/sfs)

[![](media/rxstudio_logo.png){fig-alt="Rx Studio logo" fig-align="left" width="200"}](https://rx.studio)
:::

Further sponsors welcome to support participant travel, accommodation and/or social events. Sponsors will be acknowledged on this website, on the R Contributors [Twitter](https://twitter.com/R_Contributors) and [Mastodon](https://hachyderm.io/@R_Contributors) accounts, and in reports of the sprint. Please contact [r-project-sprint-2023\@gaggle.email](mailto:r-project-sprint-2023@gaggle.email) to discuss!
